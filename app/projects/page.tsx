...
export const metadata: Metadata = buildMetadata({
  ...
  keywords: [
    ...
    "residential plots Shadnagar", "gated community Mokila",
    "villas Kokapet", "plots Adibatla", "township Tukkuguda",
    "commercial plots Gachibowli", "Pan Meadows", "Pan Green Valley",
    "Pan Heights", "Pan Golden Acres", "Pan Smart City", "Pan Commercial Park",
